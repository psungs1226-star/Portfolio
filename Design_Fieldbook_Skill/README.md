...
제작에 사용한 Claude의 자기평가로 끝내지 않고, 완성된 A/B/C HTML을 **GPT-5.6 High와 Gemini 3.1 Pro에 각각 제공해 별도로 검수**했습니다. 두 평가의 점수 척도가 달라 평균이나 합산 점수는 만들지 않았습니다.
...
GPT-5.6은 C의 첫인상·스토리 구조·프로젝트 설득력·반응형과 인터랙션을 높게 평가했습니다. 반면 **정보 위계와 가독성은 B 18점, C 17점**으로 평가해 C가 모든 항목에서 우세한 것은 아니라고 지적했습니다.
...
Gemini 3.1 Pro는 C의 고밀도 다크 테마, Bento UI, KPI 중심 성과 표현과 구현된 인터랙션을 강점으로 평가했습니다.
...
스킬 핵심부는 `SKILL.md`와 참고자료·스크립트·데모·프로브를 포함한 **27개 파일, 약 7,120줄**로 구성되어 있습니다.
