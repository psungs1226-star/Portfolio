...
<details>
<summary><strong>※ 같은 플랫폼에서 진행한 APEX AI 역량분석</strong></summary>

별도 APEX 평가에서는 개발 비전공자로서 Claude 이론 테스트와 Codex·Hono 실기 과제를 수행해 **Expert AI 역량 결과**를 받았습니다.
...
`SKILL.md`와 참고자료·검증 스크립트·장르별 프로브를 포함한 **25개 파일, 약 6,090줄**로 구성했습니다.

**한계:** 검수와 수정 단계를 여러 번 통과하므로 단순 생성보다 시간이 오래 걸립니다. 속도보다 결과의 일관성과 재현성이 중요한 작업에 적합합니다.
