...
| 설계 축 | 판단과 실행 |
|:---:|---|
| **Problem** | 비개발 직군은 코딩테스트처럼 표준화된 실무 검증 수단이 부족하고, 서류만으로는 AI 활용 역량과 실제 문제해결 방식을 확인하기 어려움 |
| **Product** | 실제 스타트업 문제를 본인 장비·AI 도구·자료로 해결하는 2시간 온라인 시험. 경력자 분포 안에서 위치를 보여주고 상위권을 기업 컨택으로 연결 |
| **Business** | 응시료가 아닌 **성사 수수료 + 우선 컨택권**을 매출원으로 설정. 응시자 300명·성사 3건·구매 기업 5곳 가정에서 회차 매출 510~725만원, 반복 비용 34.6~64만원 |
| **Execution** | 문제 정의용 공고 1,000건과 BD 타겟 선정용 공고 600건을 분석하고, 타겟 기업 20곳·세일즈 1페이저·콜드메일 3종·가격표·파이프라인·2주 실행 캘린더까지 제작 |
...
### 04. 사주 다이어리 — 여러 앱의 사용 목적을 흡수하는 데일리 앱
...
`SKILL.md`와 참고자료·검증 스크립트·장르별 프로브를 포함한 **29개 파일, 약 7,940줄**로 구성했습니다.
