...
- **주요 결과:** 그룹바이 신사업 제안, Forant LIVE 출시, Apps in Toss 미니앱 2건 출시, AX 인재전쟁 예선 상위 10%, 인사ON·PDF-to-Bot MCP 구축

---

## 🚀 Featured Work

### 01. Forant — 한국 주식 스윙 판단·복기 훈련

> 수익률을 알려주는 도구가 아니라, **판단 → 공개 → 결과 → 복기**를 반복하며 투자 습관을 검증하는 서비스입니다.

Forant는 결과를 알고 난 뒤 과거를 해석하는 백테스트의 한계에서 출발했습니다. 당시 공개된 정보만으로 먼저 판단을 기록하고, 결과가 공개된 뒤 실제 행동과 계획을 비교해 복기하는 흐름을 만들었습니다. 수익률이나 정답을 알려주는 도구가 아니라, 반복되는 판단 습관을 스스로 확인하도록 돕는 한국 주식 스윙 매매 훈련 서비스입니다.

- **판단 기록:** 매수·관망·패스를 선택하고 익절·손절 계획을 먼저 확정
- **미래 정보 차단:** 다음 봉은 서버가 한 장면씩 공개해 결과를 미리 볼 수 없도록 설계
- **훈련 시나리오:** 돌파와 눌림을 서로 다른 상태와 종료 조건으로 구성
- **행동 복기:** 추격매수·손절선 변경·계획 외 청산 등 행동 태그와 판단 타임라인 제공
- **현재 상태:** 모바일 웹으로 배포 완료, 이후 완주율·재방문·지불 의향 검증 예정

<p align="center">
  <img src="Forant/assets/forant-01-pullback-scenario.png" width="260" alt="Forant 눌림 3차 분할매수 시나리오">
  <img src="Forant/assets/forant-02-review-flow.png" width="260" alt="Forant 결과 복기 흐름">
  <img src="Forant/assets/forant-03-ai-vs-result.png" width="260" alt="Forant AI 예측과 실제 결과 비교">
</p>
<p align="center"><sub>눌림 3차 분할매수 시나리오 · 결과 복기 흐름 · AI 예측과 실제 결과 비교</sub></p>

→ [Forant 사용하기](https://forant.vercel.app/)

---

### 02. 그룹바이 채용 플랫폼 신사업 — AI 실무능력시험

> **서류 밖의 실무 역량을 새로운 매칭 신호로 만들 수 있을까?**<br>
> 그룹바이 공개자료에서 출발해 문제의 크기, 제품 구조, 수익성, 영업 실행과 중단 기준까지 설계한 신사업 제안입니다.

<p align="center">
  <a href="Groupby_BD/AI실무능력시험_제안덱.pdf">
    <img src="Groupby_BD/assets/proposal-cover.png" width="900" alt="경력직 AI 실무능력시험 신사업 제안덱 표지">
  </a>
</p>
<p align="center"><sub>표지를 누르면 33쪽 제안덱이 열립니다.</sub></p>

<table>
  <tr>
    <td align="center"><strong>약 72%</strong><br><sub>공고 1,000건 중 비개발 직군</sub></td>
    <td align="center"><strong>510~725만원</strong><br><sub>기준 시나리오 회차 매출</sub></td>
    <td align="center"><strong>20곳</strong><br><sub>공개 공고 600건 기반 BD 타겟</sub></td>
  </tr>
</table>
...
### 03. 인사ON → PDF-to-Bot MCP — 사내 데이터 챗봇을 위한 선행 실험과 확장
...
<p align="center">
  <sub>공개된 공무원 인사 법령을 바탕으로 휴직 기간·복직일·지급 반기를 함께 판단한 실행 화면</sub>
</p>
...
### 04. AX 인재전쟁 — 다양한 산업 문제를 AI로 해결해 예선 상위 10%
...
### 06. Design Fieldbook — AI slop을 줄이는 디자인 판단 시스템
...
### 07. Design Fieldbook Skill — 디자인 판단을 AI 작업 절차로 만든 스킬
