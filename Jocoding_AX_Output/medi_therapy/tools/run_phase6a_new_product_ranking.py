  ...
  <main>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        <table>
          <thead>
            <tr><th>순위</th><th>후보</th><th>세그먼트</th><th>점수</th><th>상태</th><th>핵심 매칭</th><th>콘텐츠 매칭</th></tr>
          </thead>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        <table>
          <thead>
            <tr><th>순위</th><th>후보</th><th>상태</th><th>보류 사유</th></tr>
          </thead>
...
### Codex 사전 검토 결과
- 산출물: `submission/src/data/new_product_rankings.json`, `submission/logs/new_product_matching_trace.jsonl`, `submission/logs/new_product_ranking_report.md`, `submission/logs/new_product_ranking_report.html`
